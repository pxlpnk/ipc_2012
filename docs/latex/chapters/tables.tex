...
\caption{Benchmark results showing \textbf{run time per instance size} of the \textbf{data-parallel} in \textbf{Cilk}.}
...
\caption{Benchmark results showing \textbf{run time per instance size} of the \textbf{task-parallel} in \textbf{Cilk}.}
