...
\caption{Benchmark results showing the \textbf{MPI\_Allgather} implementation with \textbf{NEC-MPI} for a \textbf{variable proc size of 1..10 } and a \textbf{fixed N 10000}.}
...
\caption{Benchmark results showing the \textbf{MPI\_ReduceScatter} implementation with \textbf{NEC-MPI} for a \textbf{variable proc size of 1..10 } and a \textbf{fixed N 10000}.}
