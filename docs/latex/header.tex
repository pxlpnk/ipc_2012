...
\usepackage{stackrel}
\newcommand*{\textstackrel}[2]{\ensuremath{\stackrel{\hbox{#1}}{\hbox{#2}}}}
...
%\usepackage{TUINFDA} % tu template style
\newcommand{\thesiskeywords}{Masters's thesis} % default keywords

\InputIfFileExists{private}{}{} % defines macros like thesis title etc. mainly used on the titlepages
